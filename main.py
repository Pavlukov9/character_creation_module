...
def attack(char_name: str, char_class: str) -> str:
    """Нанесённый урон в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокированный урон в зависимости от выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Специальное умение в зависимости от выбранного класса."""
    if char_class == 'warrior':
